...
**تاریخ اجرا:** 2026-05-09 19:05:47

## خلاصه آماری

| معیار | مقدار |
|-------|-------|
| **کل کانال‌های بررسی شده** | `1728` |
| **✅ کانال‌های فعال** (باقی‌مانده در `channels.csv`) | `241` |
| **📁 منتقل شده به آرشیو اخیر** (۳۰–۳۶۵ روز) | `980` |
| **🗄️ منتقل شده به آرشیو قدیم** (بیش از ۳۶۵ روز) | `507` |

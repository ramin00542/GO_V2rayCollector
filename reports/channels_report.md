...
**تاریخ اجرا:** 2026-06-25 06:07:32

## خلاصه آماری

| معیار | مقدار |
|-------|-------|
| **کل کانال‌های بررسی شده** | `1141` |
| **✅ کانال‌های فعال** (باقی‌مانده در `channels.csv`) | `308` |
| **📁 منتقل شده به آرشیو اخیر** (۳۰–۳۶۵ روز) | `832` |
| **🗄️ منتقل شده به آرشیو قدیم** (بیش از ۳۶۵ روز) | `588` |

...
**تاریخ اجرا:** 2026-06-02 06:36:46
...
| **✅ کانال‌های فعال** (باقی‌مانده در `channels.csv`) | `286` |
| **📁 منتقل شده به آرشیو اخیر** (۳۰–۳۶۵ روز) | `878` |
| **🗄️ منتقل شده به آرشیو قدیم** (بیش از ۳۶۵ روز) | `564` |

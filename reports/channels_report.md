...
**تاریخ اجرا:** 2026-07-01 06:24:42

## خلاصه آماری

| معیار | مقدار |
|-------|-------|
| **کل کانال‌های بررسی شده** | `1129` |
| **✅ کانال‌های فعال** (باقی‌مانده در `channels.csv`) | `278` |
| **📁 منتقل شده به آرشیو اخیر** (۳۰–۳۶۵ روز) | `850` |
| **🗄️ منتقل شده به آرشیو قدیم** (بیش از ۳۶۵ روز) | `600` |

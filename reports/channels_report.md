...
**تاریخ اجرا:** 2026-06-26 06:09:48

## خلاصه آماری

| معیار | مقدار |
|-------|-------|
| **کل کانال‌های بررسی شده** | `1140` |
| **✅ کانال‌های فعال** (باقی‌مانده در `channels.csv`) | `301` |
| **📁 منتقل شده به آرشیو اخیر** (۳۰–۳۶۵ روز) | `838` |
| **🗄️ منتقل شده به آرشیو قدیم** (بیش از ۳۶۵ روز) | `589` |

...
**تاریخ اجرا:** 2026-06-27 05:55:01

## خلاصه آماری

| معیار | مقدار |
|-------|-------|
| **کل کانال‌های بررسی شده** | `1139` |
| **✅ کانال‌های فعال** (باقی‌مانده در `channels.csv`) | `289` |
| **📁 منتقل شده به آرشیو اخیر** (۳۰–۳۶۵ روز) | `848` |
| **🗄️ منتقل شده به آرشیو قدیم** (بیش از ۳۶۵ روز) | `591` |

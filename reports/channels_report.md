...
**تاریخ اجرا:** 2026-07-07 06:06:56
...
| **✅ کانال‌های فعال** (باقی‌مانده در `channels.csv`) | `249` |
| **📁 منتقل شده به آرشیو اخیر** (۳۰–۳۶۵ روز) | `874` |
| **🗄️ منتقل شده به آرشیو قدیم** (بیش از ۳۶۵ روز) | `605` |

...
**تاریخ اجرا:** 2026-05-09 16:37:16

## خلاصه آماری

| معیار | مقدار |
|-------|-------|
| **کل کانال‌های بررسی شده** | `1729` |
| **✅ کانال‌های فعال** (باقی‌مانده در `channels.csv`) | `240` |
| **📁 منتقل شده به آرشیو اخیر** (۳۰–۳۶۵ روز) | `959` |
| **🗄️ منتقل شده به آرشیو قدیم** (بیش از ۳۶۵ روز) | `530` |

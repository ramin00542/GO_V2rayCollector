...
**تاریخ اجرا:** 2026-05-10 06:16:39

## خلاصه آماری

| معیار | مقدار |
|-------|-------|
| **کل کانال‌های بررسی شده** | `1178` |
| **✅ کانال‌های فعال** (باقی‌مانده در `channels.csv`) | `235` |
| **📁 منتقل شده به آرشیو اخیر** (۳۰–۳۶۵ روز) | `940` |
| **🗄️ منتقل شده به آرشیو قدیم** (بیش از ۳۶۵ روز) | `553` |
